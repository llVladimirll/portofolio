        ...
        <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
            <defs>
                ...
                <pattern id="circles" width="100" height="100" patternUnits="userSpaceOnUse">
                    <circle cx="50" cy="50" r="20" fill="none" stroke="currentColor" strokeWidth="0.5" strokeOpacity="0.1" />
                </pattern>
            </defs>
            ...
            <div className="max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between w-full relative z-10">
                ...
                >
                    <h1 className="text-4xl md:text-5xl font-bold mb-4">
                        Hi, I'm <span className="text-elegant-secondary">Vladimirrahman Salsabil Abdullah</span>
                    </h1>
                    <h2 className="text-2xl md:text-3xl mb-6">
                        I'm a{" "}
                        <TypeAnimation
                            sequence={["Fullstack Developer", 2000, "Problem Solver", 2000, "Tech Enthusiast", 2000]}
                            wrapper="span"
                            speed={50}
                            repeat={Number.POSITIVE_INFINITY}
                ...
                >
                    <div
                        className="relative w-64 h-64 md:w-80 md:h-80 overflow-hidden transition-all duration-300 ease-in-out transform hover:scale-105 rounded-full">
                        <Image
                        ...
                        {isHovered && (
                            <div
                                className="absolute inset-0 bg-elegant-secondary bg-opacity-75 flex items-center justify-center rounded-full">
                                <p className="text-elegant-accent text-xl font-bold">That's Me!</p>
                            </div>
                        )}
                    </div>
                </motion.div>
